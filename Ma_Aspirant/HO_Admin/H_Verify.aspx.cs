...
{
    public partial class H_Verify : System.Web.UI.Page
    {
       ...
       // static string ibr = "";
        ...
        public static List<cand_code> cand_codedtl(string input)
        {
            ...
            ds = obj.proc_hrm_common_select("44","44", input);
            try
            {
                if (ds.Rows.Count > 0)
                {
          ...
          public static string cand_detail(string cid)
          {
              ...
              ds = obj.proc_hrm_common_select("44","46", cid);
        ...
        public List<Experience> emp_exp { get; set; }
        [WebMethod(EnableSession = true)]
        public static List<Experience> get_Experience(string sid)
        {

            List<Experience> emp_exp = new List<Experience>();
            ServiceReference1.ServiceClient obj = new ServiceReference1.ServiceClient();
            DataTable ds = new DataTable();
            System.Net.ServicePointManager.SecurityProtocol = System.Net.SecurityProtocolType.Tls | System.Net.SecurityProtocolType.Tls11 | System.Net.SecurityProtocolType.Tls12;

            ds = obj.proc_hrm_common_select("44", "82", sid);
            try
            {
                if (ds.Rows.Count > 0)
                {
                    foreach (DataRow dr in ds.Rows)
                    {
                        emp_exp.Add(new Experience()
                        {
                            ...
                            orgtype = dr["org_type"].ToString(),
                            country = dr["country"].ToString(),
                            pfromdate = dr["period_fromdt"].ToString(),
                            ptodate = dr["period_todt"].ToString(),
                            Rmarks = dr["remarks"].ToString()
                            // NO_OF_ATTEMPT1 = dr["NO_OF_ATTEMPT"].ToString(),
                        });
                    }
                }
        ...
        public static string approve(string input)
        {
            ...
            ds = obj.proc_hrm_common_select("44","42", input);
        ...
        public static string get_emp_dtl(string input)
        {
            ...
            ds = obj.proc_hrm_common_select("44","61", input);
        ...
        public static string get_family_dtl2(string input)
        {
            ...
            ds = obj.proc_hrm_common_select("44","63", input);
        ...
        public static List<empsib> get_sib_dtl(string input)
        {
            ...
            ds = obj.proc_hrm_common_select("44","64", input);

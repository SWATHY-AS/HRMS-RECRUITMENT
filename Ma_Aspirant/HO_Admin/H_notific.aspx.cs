...
{
    public partial class H_notific : System.Web.UI.Page
    {
        ...
        public static string branch_detail(string input)
        {
            ...
            ds = obj.proc_hrm_common_select("44","10", input);


            try
            {
               
                br_name = ds.Rows[0][1].ToString();
        ...
        public static List<cand_code> cand_codedtl(string input)
        {
            ...
            ds = obj.proc_hrm_common_select("44","28", input);
            try
            {
                if (ds.Rows.Count > 0)
                {
        ...
        public static string cand_detail(string cid)
        {
            ...
            ds = obj.proc_hrm_common_select("44","21", cid);
        ...
        public static string insert_detail(string date, string time,string code,string number, string name,string brname)
        {
            ...
            System.Net.ServicePointManager.SecurityProtocol = System.Net.SecurityProtocolType.Tls | System.Net.SecurityProtocolType.Tls11 | System.Net.SecurityProtocolType.Tls12;
                        ...
                        ds = obj.proc_hrm_common_select("44","29", date + '~' + time+'~'+ code);
                        ...
                        if (res1 == "111")
              {
               ...
               //  sms.ser_flag = 0;
                  ...
                  sms.Message = "Hi " + name + ",Your Interview scheduled at Manappuram Head office " + brname + " on " + date + " at" + time + ".Please bring all mandatory documents you uploaded in the website.";
                    ...
                    string s = "", num="";
                    ds = obj.proc_hrm_common_select("44","68", code);
                    if (ds.Rows.Count > 0)
                    {
                  ...
                  //  mail.Body = "Dear  " + name + "," + " \r\n\r\n  Your Interview scheduled at Manappuram Branch " + brname + " on " + date + " at" + time + ". \r\n Please use application number " + code + " to login to our site https://online.manappuram.com/Recruitment/Login.aspx and  \r\n complete the shortlisting process (upload documents,add personal and qualification details) and bring all mandatory documents you uploaded in the website.\r\n   Documents :\r\nQualification Certificate,Pancard,Aadhar Card,Bank PassBook,Voter ID,Address Proof";
                    mail.Body = "Dear " + name + ", \r\n\r\n Your Interview scheduled at Manappuram Head Office " + brname + " on " + date + " at" + time + ". \r\n\r\n Your application number is" + qq[0].ToString() + "Please bring all mandatory documents you uploaded in the website. \r\n\r\n  Mandatory Documents : \r\n\r\n Qualification Certificate,Pancard,Aadhar Card,Bank PassBook,Voter ID,Address Proof \r\n\r\nThanks & Regards, \r\n\r\nManappuram HR \r\n\r\nContact Number" + num;

<%@ Page Title="" Language="C#" MasterPageFile="~/HO_Admin.Master" AutoEventWireup="true" CodeBehind="H_notific.aspx.cs" Inherits="Ma_Aspirant.Recruitment.H_notific" %>
     ...
     <script>
         ...
         function verify_tab() {
          ...
          function isNumberKey(evt, element) {
           ...
           function next() {
             window.location.href = "H_Verify.aspx";
           }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <button type="button" class="close col-md-3" data-dismiss="alert" aria-label="Close">  <span aria-hidden="true">&times;</span>
                                 ...
                                 <%--<span class="col-md-3"> </span>--%>
                                    ...
                                    <div class="widget-header clonedInput">
                                        <h4><span class="glyphicon glyphicon-zoom-in"  hidden="hidden"></span><span class="required"  hidden="hidden" style="color:red"> *Schedule Interview between    <label id="fromdat"  hidden="hidden" class="cntr-text">00/00/0000</label> and   <label id="todat"  hidden="hidden" class="cntr-text">00/00/0000</label></span></h4>
                                    </div>

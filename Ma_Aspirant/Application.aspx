<%@ Page Title="" Language="C#" MasterPageFile="~/Candidate.Master" AutoEventWireup="true" CodeBehind="Application.aspx.cs" Inherits="Ma_Aspirant.Application" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
  
        <script src="App_Themes/Theme/assets/js/appli_new.js"></script>

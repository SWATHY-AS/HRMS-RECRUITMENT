<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="BH_Verify.aspx.cs" Inherits="Ma_Aspirant.Recruitment.BH_Verify" %>
     ...
     <script type="text/javascript">
         ...
         function pic_tab() {
          ...
          function isNumberKey(evt, element) {
           ...
           function next() {
             window.location.href = "Photo_Upload.aspx";
        }
        ...
        function emp_download() {
            ...
            $.ajax({
                ...
                url: "BH_Verify.aspx/cand_codedtl",
                data: "{input:'" + dat + "'}",
                dataType: "json",
                success: function (Result) {
                    ...
                    $("#cmb_appId_doc").change(function () {
                        ...
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: "BH_Verify.aspx/cand_detail",
                            data: "{cid:'" + sid + "'}",
                            dataType: "json",
                            success: function (Result) {
                        ...
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: "BH_Verify.aspx/get_doc_dtl",
                            data: "{ input: '" + sid + "' }",
                            dataType: "json",
                            success: function (Result) {
        ...
        function empq_dtl(sid) {
          //  var emp = $("#ddl_q_emp").val();
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "BH_Verify.aspx/get_qual_dtl",
                data: "{ input: '" + sid + "' }",
                dataType: "json",
                success: function (Result) {
                    // alert(Result.d);
        ...
        function emp_dtl(sid) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "BH_Verify.aspx/get_emp_dtl",
                data: "{ input: '" + ee + "' }",
                dataType: "json",
                success: function (Result) {
...
//c.pp,c.local_body_perm,c.local_body_pres,c.further_study, c.willing_towrk
        ...
        function empfamily_dtl_edit(sid) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "BH_Verify.aspx/get_family_dtl2",
                data: "{ input: '" + emp + "' }",
                dataType: "json",
                success: function (Result) {
        ...
        function sibling(sid) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "BH_Verify.aspx/get_sib_dtl",
                data: "{ input: '" + emp + "' }",
                // data:{},
                dataType: "json",
                success: function (Result) {
        ...
        function empref_dtl(sid) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "BH_Verify.aspx/get_ref_dtl",
                data: "{ input: '" + sid + "' }",
                dataType: "json",
                success: function (Result) {
                    // alert(Result.d);
        ...
        function dwnld(row) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "BH_Verify.aspx/Documents_download",
                    ...
                    OpenDialog(myUrl, 875, 650, function (termsOfServiceAccepted)
                    {
                        if (termsOfServiceAccepted)
                        {
                            $.ajax({
                                type: "POST",
                                contentType: "application/json;charset=utf-8",
                                url: "BH_Verify.aspx/deleteDownloadFile",
                                data: "{ input: '" + fileName + "' }",
                                dataType: "json",
                                success: function (Result) {
                                },
        ...
        function confirm_basic()
        {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "BH_Verify.aspx/insert_detail",
                data: "{input:'" + dt + "'}",
                dataType: "json",
                success: function (Result) {
                    var res = Result.d;
            ...
            if (c == 0 || a == 1 || cmt == '') {
                ...
                $.ajax({
                    ...
                    success: function (Result) {
                        var res1 = Result.d
                        alert(res1);
                        window.open("BH_Verify.aspx", "_self");
                    },
                    error: function (Result) {
                    }
                });

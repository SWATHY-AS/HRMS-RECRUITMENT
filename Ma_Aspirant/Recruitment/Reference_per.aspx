<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Reference_per.aspx.cs" Inherits="Ma_Aspirant.Recruitment.Reference_per" %>
    ...
    <script>
        ...
        function check_tab() {
            ...
            $.ajax({                ///university
                ...
                url: "Reference_per.aspx/get_form",
                data: "{ input : '" + empid + "' }",
                dataType: "json",
        ...
        function refcheck() {
            ...
            $.ajax({                ///university
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Reference_per.aspx/get_ref_dtl",
                data: "{ input : '" + empid + "' }",
                dataType: "json",
                success: function (Result) {
                    Result = Result.d;
        ...
        function next() {
             window.location.href = "Agreement_Info.aspx"
        }
        ...
        function post_select_ref1() {
            ...
            if (ppin != '') {
                ...
                $.ajax({
                    type: "POST",
                    url: 'Reference_per.aspx/postofc_dtl',
                    data: "{did:'" + ppin + "'}",
                    async: false,
                    cache: false,
                    contentType: "application/json; charset=utf-8",
        ...
        function addr_ref1() {
            ...
            if (dpid != -1) {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "Reference_per.aspx/get_address",
                    data: "{input:'" + dpid + "'}",
                    async: false,
                    cache: false,
                    dataType: "json",
        ...
        function empref_dtl(empid) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Reference_per.aspx/get_ref_dtl_view",
                data: "{ input: '" + empid + "' }",
                dataType: "json",
                success: function (Result) {
                    // alert(Result.d);

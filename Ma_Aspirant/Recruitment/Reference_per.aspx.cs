...
{
    public partial class Reference_per : System.Web.UI.Page
    {
        ...
        public static string cand_detail()       {
            ...
            {
                //27may change name
                s = ds.Rows[0][0].ToString() + "~" + ds.Rows[0][1].ToString() + "~" + ds.Rows[0][10].ToString();
            }
            return s;

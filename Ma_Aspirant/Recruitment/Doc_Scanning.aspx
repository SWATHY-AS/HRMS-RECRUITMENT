<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Doc_Scanning.aspx.cs" Inherits="Ma_Aspirant.Recruitment.Doc_Scanning" %>
    ...
    <script type='text/javascript'>
        ...
        function check_tab() {
          //  alert("checktab");
                   ...
                   $.ajax({                ///university
                       type: "POST",
                       contentType: "application/json; charset=utf-8",
                       url: "Doc_Scanning.aspx/get_form1",
                       data: "{ input : '" + empid + "' }",
                       dataType: "json",
                       success: function (Result) {
                           Result = Result.d;
                           ...
                           //  alert(Result);
                           if (Result == "222") {
                               alert("Please fill Common Nomination Details details");
        ...
        function document1() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Doc_Scanning.aspx/doc_dtl_view",
                data: {},
                dataType: "json",
                success: function (Result) {
                    Result = Result.d;
                    ...
                    $("#dd_doc1").change(function () {
                        ...
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                            url: "Doc_Scanning.aspx/doc_parent", // 
                            data: "{input:'" + sid + "'}",
                            dataType: "json",
                            success: function (Result) {
                                res = Result.d;
                                if (res > 0)
                                {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        contentType: "application/json; charset=utf-8",
                                        url: "Doc_Scanning.aspx/doc_dtl_view1", // 
                                        data: "{input:'" + sid + "'}",
                                        dataType: "json",
                                        success: function (Result) {
                                            Result = Result.d;
        ...
        function SaveImage() {
                     ...
                     //  var cc = emp + "~" + doc1 + "~" + doc2 + "~" + des1 + "~" + sess + "~" + d3[0] + "~" + fileName;
                       ...
                       // alert(cc);
                        $.ajax({
                            type: "POST",
                            contentType: "application/json; charset=utf-8",
                           url: "Doc_Scanning.aspx/Documents_upload",
         ...
         function next() {
             window.location.href = "../Recruitment/Reference_per.aspx";
        }
        ...
        //27 change
         function empdoc()
         {
             ...
             $.ajax({
                 type: "POST",
                 contentType: "application/json; charset=utf-8",
                 url: "Doc_Scanning.aspx/get_doc_dtl_view",
                 data: "{ input: '" + empid + "' }",
                 dataType: "json",
                 success: function (Result) {
                     for (var i = 0; i < Result.d.length; i++) {
         ...
         function dwnld(row) {
             ...
             $.ajax({
                 type: "POST",
                 contentType: "application/json; charset=utf-8",
                 url: "Doc_Scanning.aspx/Documents_download",
                     ...
                     OpenDialog(myUrl, 875, 650, function (termsOfServiceAccepted) {
                         if (termsOfServiceAccepted) {
                             $.ajax({
                                 type: "POST",
                                 contentType: "application/json;charset=utf-8",
                                 url: "Doc_Scanning.aspx/deleteDownloadFile",
                                 data: "{ input: '" + fileName + "' }",
                                 dataType: "json",
                                 success: function (Result) {
                                 },
                             ...
                             if (fileList.length == 1) {
                                 ...
                                 fileReader.onload = function () {
                                     ...
                                     $.ajax({
                                         type: "POST",
                                         contentType: "application/json; charset=utf-8",
                                         url: "Doc_Scanning.aspx/Doc_upload",
                                         data: "{input: '" + cc + "',upload_file: '" + imageData + "'}",
                         ...
                         <label class="col-md-4 cntr-text">• Address Proof</label>
                             <label class="col-md-4 cntr-text">• Qualification Documents(sslc,Plustwo,Degree,PG etc..)</label>
                               ...
                               <div class="widget box align-center"> <br /><br />
                                ...
                                <input id="btn_exit" type="button" value="Next"  class="btn btn-info" onclick="next()" style="border-radius:25px;width:180px" />
       </div>
             </div>     
             </form> 
            </div>

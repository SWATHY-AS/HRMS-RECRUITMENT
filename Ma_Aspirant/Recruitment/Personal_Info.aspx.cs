     ...
     //       r_idtype + "~" + r_vote_id + "~" + r_name + "~" + r_hname + "~" + r_dist + "~" + r_state + "~" + r_dob + "~" + r_gender + "~" + r_age + "~" + r_mob + "~" + r_email + "~" + r_qual + "~" + r_university + "~" + r_mark + "~" + r_pyear + "~" + r_baccount + "~" + r_ifsc + "~" + r_pan + "~" + r_reg + "~" + r_br + "~" + r_post;
            ...
            //{
             ...
             System.Net.ServicePointManager.SecurityProtocol = System.Net.SecurityProtocolType.Tls | System.Net.SecurityProtocolType.Tls11 | System.Net.SecurityProtocolType.Tls12;
                        ...
                        ds = obj.get_data(18, data);//swathy19dec
       ...
       //     sms1.Message = "Please use the recieved code to login to our site 10.0.0.111/Recruitment/Login.aspx and complete the shortlisting process.";
            sms.Message = "Notification to schedule an Interview. Please visit the website!!";
            System.Net.ServicePointManager.SecurityProtocol = System.Net.SecurityProtocolType.Tls | System.Net.SecurityProtocolType.Tls11 | System.Net.SecurityProtocolType.Tls12;
         ...
         // //  string msgid1 = sms1.SendSms();
           sms.mobileNumber = vOut1;
           // smsbh.account_id = 3;
            string msgid2 = sms.SendSms(); // bh
                                             //return "SUCCESS";

<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="family_status.aspx.cs" Inherits="Ma_Aspirant.Recruitment.family_status" %>

     

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
      
     <script type="text/javascript" src="../App_Themes/Theme/assets/js/family.js"></script>
           ...
           <script type='text/javascript'>
               ...
               function check_tab() {
                   ...
                   $.ajax({                ///university
                       ...
                       url: "family_status.aspx/get_form",
                       data: "{ input : '" + empid + "' }",
                       dataType: "json",
               ...
               function qual_chk() {
                   ...
                   $.ajax({                ///university
                       type: "POST",
                       contentType: "application/json; charset=utf-8",
                       url: "family_status.aspx/get_family",
                       data: "{ input : '" + empid + "' }",
                       dataType: "json",
                       success: function (Result) {
                           Result = Result.d;
               ...
               function empfamily_dtl_edit(empid) {
                 ...
                 //  var emp = $("#cmb_appId_doc").val();
                   ...
                   $.ajax({
                       type: "POST",
                       contentType: "application/json; charset=utf-8",
                       url: "family_status.aspx/get_family_dtl2",
                       data: "{ input: '" + empid + "' }",
                       dataType: "json",
                       success: function (Result) {
               ...
               function sibling(empid) {
                   ...
                   $.ajax({
                       type: "POST",
                       contentType: "application/json; charset=utf-8",
                       url: "family_status.aspx/get_sib_dtl",
                       data: "{ input: '" + empid + "' }",
                       // data:{},
                       dataType: "json",
                       success: function (Result) {

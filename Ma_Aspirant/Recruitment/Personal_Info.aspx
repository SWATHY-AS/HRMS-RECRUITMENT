<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Personal_Info.aspx.cs" Inherits="Ma_Aspirant.Recruitment.Personal_Info" %>
               ...
               if (fileReader && fileList && fileList.length) {
                   ...
                   fileReader.onload = function () {
                       ...
                       $.ajax({
                           ...
                           url: "Personal_Info.aspx/Documents_upload",
    ...
    <object width="500" height="300">
		...
		<embed src="../WebcamResources/save_picture.swf" width="405" height="190"/>
              ...
              <input type="text" class="form-control" id="txt_dob" name="dob" maxlength="25" required="required" onmousedown="return DOBNull()" onblur="leftTrim(this)" autocomplete="off" disabled="disabled"  onkeypress="return onlyAlphabets(event,this);" onkeyup="this.value=this.value.toUpperCase()" />
                              ...
                              <label class="col-md-2 cntr-text">Gender(M/F)</label>
                            <div class="col-md-4"> 
                                <input type="text" class="form-control" id="txt_gender" name="gender" maxlength="1" required="required" onblur="leftTrim(this)" autocomplete="off" disabled="disabled" onkeypress="return onlyAlphabets(event,this);" onkeyup="this.value=this.value.toUpperCase()" />
                            </div>
                        </div>

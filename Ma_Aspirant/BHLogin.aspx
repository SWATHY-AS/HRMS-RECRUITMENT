<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BHLogin.aspx.cs" Inherits="Ma_Aspirant.BHLogin" %>
...
<head id="Head1" runat="server">
   <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
    ...
    <script type="text/javascript" src="App_Themes/Theme/assets/js/BHlogin.js"></script>
    
    <script>$(document).ready(function () { BHLogin.init() });</script>
            ...
            <form id="Form1" class="form-vertical login-form" runat ="server" >
                ...
                <div class="form-group">
                    <div class="input-icon">
                        ...
                        <input type="text" name="txt_usernumber" id="txt_usernumber" style="border-radius:8px" class="form-control" placeholder="Mobile Number" autofocus="autofocus" data-rule-required="true" runat="server" data-msg-required="Please enter your mobile number." />
                        <br />
                         <div class="input-icon">
                        <i class="icon-user"></i>
                        <input type="text" name="empcode" id="txt_empcode" style="border-radius:8px" class="form-control" placeholder="Employee Code" autofocus="autofocus" data-rule-required="true" runat="server" data-msg-required="Please enter your employe code." />

<%@ Page Title="" Language="C#" MasterPageFile="~/Candidate.Master" AutoEventWireup="true" CodeBehind="logout_Admin.aspx.cs" Inherits="Ma_Aspirant.logout_Admin" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function loginagn() {
            ...
            window.location.href = "../HO_Admin/H_Login.aspx";
        }
    </script>
</asp:Content>

<%@ Page Title="" Language="C#" MasterPageFile="~/Main_HO.Master" AutoEventWireup="true" CodeBehind="Personal_Details_HO.aspx.cs" Inherits="Ma_Aspirant.Recruitment.Personal_Details_HO" %>
    ...
    <script>
        $(window).load(function () {
          ...
          //  GetAllProperties();
            ...
            $.ajax({                ///State 
                ...
                url: "../HO_Website/Personal_Details_HO.aspx/state_dtl",
                data: {},
                dataType: "json",
                success: function (Result) {
                    ...
                    $("#dd_st2").change(function () {
                        ...
                        if (!isNaN(sid)) {
                            ...
                            $.ajax({
                                type: "POST",
                                url: '../HO_Website/Personal_Details_HO.aspx/dist_dtl',
                                data: "{stid:'" + sid + "'}",
                                async: false,
                                cache: false,
                                contentType: "application/json; charset=utf-8",
                                ...
                                success: function (Result) {
                                    ...
                                    $("#dd_dist2").change(function () {
                                        ...
                                        if (!isNaN(dsid)) {
                                            ...
                                            $.ajax({
                                                type: "POST",
                                                url: '../HO_Website/Personal_Details_HO.aspx/post_dtl',
                                                data: "{did:'" + dsid + "'}",
                                                async: false,
                                                cache: false,
                                                contentType: "application/json; charset=utf-8",
                                                    ...
                                                    $("#dd_post2").change(function () {
                                                        ...
                                                        if (!isNaN(dpid)) {
                                                            ...
                                                            $.ajax({
                                                                type: "POST",
                                                                contentType: "application/json; charset=utf-8",
                                                                url: "../HO_Website/Personal_Details_HO.aspx/get_pin",
                                                                data: "{pid:'" + dpid + "'}",
                                                                async: false,
                                                                cache: false,
                                                                dataType: "json",
            ...
            $.ajax({                ///blood group
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "../HO_Website/Personal_Details_HO.aspx/blood_dtl",
                data: {},
                dataType: "json",
                success: function (Result) {
                    Result = Result.d;
            ...
            $.ajax({                ///Religion
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "../HO_Website/Personal_Details_HO.aspx/religion_dtl",
                data: {},
                dataType: "json",
                success: function (Result) {
                    Result = Result.d;
       ...
       // function cand_load() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "../HO_Website/Personal_Details_HO.aspx/cand_detail",
                //  data: {},
                data: "{input:'" + empid + "'}",
                dataType: "json",
                success: function (Result) {
       ...
       // }
        ...
        function postoffc() {
            ...
            if (ppin != '') {
                ...
                $.ajax({
                    type: "POST",
                    url: '../HO_Website/Personal_Details_HO.aspx/postofc_dtl',
                    data: "{did:'" + ppin + "'}",
                    async: false,
                    cache: false,
                    contentType: "application/json; charset=utf-8",
        ...
        function chkchange() {
          ...
          function isNumberKey(evt, element) {
           ...
           function next() {
               window.location.href = "../HO_Website/qualification_HO.aspx"
           ...
           function save_cand() {
               ...
               if ($('input[id=chk_ad1]').is(':checked')) {
                ...
                if (cand_mob2 == '' ||  marr == 0 || fst == 22 || wrk == 22 || localbody1 == 0 || localbody2 == 0 || cand_fname == '' || cand_postper == '' || cand_mname == '' || cand_landmark1 == '' || cand_pincode == '' || cand_pre_hname == '' || cand_blood == 0 || cand_religion == 0 || cand_landmark2 == '' || cand_emrg_name == '' || cand_emrgrel == '' || cand_emrgaddr == '' || cand_emrgno == '' || cand_emrgmail == '') {
 ...
 //     var persn_data = cand_code + "µ" + cand_name + "µ" + cand_hsname + "µ" + cand_postper11 + "µ" + cand_district1 + "µ" + cand_state1 + "µ" + cand_pre_hname + "µ" + cand_pre_post11 + "µ" + cand_pre_district + "µ" + cand_pre_state + "µ" + cand_fname + "µ" + cand_postper + "µ" + cand_pin_code2 + "µ" + cand_mob + "µ" + cand_dob1 + "µ" + cand_gender1 + "µ" + cand_mail + "µ" + cand_mrg_status + "µ" + cand_religion + "µ" + cand_cast + "µ" + cand_landmark2 + "µ" + cand_diff_abled + "µ" + cand_rmkhand + "µ" + cand_blood + "µ" + cand_landmark1 + 'µ' + e_chkaddr + 'µ' + localbody1 + 'µ' + localbody2 + 'µ' + fst + 'µ' + wrk;
     ...
     // alert(persn_data);
      ...
      $.ajax({
          type: "POST",
          contentType: "application/json; charset=utf-8",
          url: "../HO_Website/Personal_Details_HO.aspx/insert_personal",
...
if (document.getElementById) {
 ...
 if (document.getElementById) {
        ...
        function emp_dtl(emp) {
           ...
           // alert("HEllo");
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "../HO_Website/Personal_Details_HO.aspx/get_emp_dtl",
                data: "{ input: '" + emp + "' }",
                dataType: "json",
                success: function (Result) {
        ...
        function rdo_handicapped1()//swathy
        {
         ...
         <script type="text/javascript" src="../App_Themes/Theme/assets/js/personal_det_HO.js"></script>

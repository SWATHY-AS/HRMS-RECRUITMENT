ji<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="candidate_photo_HO.aspx.cs" Inherits="Ma_Aspirant.Recruitment.candidate_photo_HO" %>
    ...
    <script>  
            ...
            if (fileReader && fileList && fileList.length) {
                ...
                fileReader.onload = function () {
                    ...
                    $.ajax({
                        ...
                        url: "../HO_Website/candidate_photo_HO.aspx/Documents_upload",
        ...
        function cand_data()
        {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "../HO_Website/candidate_photo_HO.aspx/cam_upload",
                data: "{input:'" + empid + "'}",
                dataType: "json",
                beforeSend: function () {
                    return confirm("Are you sure you want to confirm?");
        ...
        function trainig() {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "../HO_Website/candidate_photo_HO.aspx/training_pdf",
                data: "{input:'" + empid + "'}",
                dataType: "json",
...
//17july2020
        ...
        function check_tab() {
            ...
            $.ajax({                ///university
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "../HO_Website/candidate_photo_HO.aspx/get_form",
                data: "{ input : '" + empid + "' }",
                dataType: "json",
                success: function (Result) {
                    Result = Result.d;

<%@ Page Title="" Language="C#" MasterPageFile="~/Main_HO.Master" AutoEventWireup="true" CodeBehind="qualification_HO.aspx.cs" Inherits="Ma_Aspirant.Recruitment.qualification_HO" %>
        ...
        <script>
            ...
            //    GetAllProperties();
                ...
                $.ajax({                ///university
                    ...
                    url: "../HO_Website/qualification_HO.aspx/univ_dtl_rec",
                    data: {},
                    dataType: "json",
                ...
                $.ajax({                ///Religion
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "../HO_Website/qualification_HO.aspx/high_qual",
                    data: "{ input: '" + empid + "' }",
                    dataType: "json",
                    success: function (Result) {
                        Result = Result.d;
            ...
            function check_tab() {
              ...
              //  alert(empid);
                $.ajax({                ///university
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "qualification_HO.aspx/get_form",
                    data: "{ input : '" + empid + "' }",
                    dataType: "json",
                    success: function (Result) {
                        Result = Result.d;
                        ...
                        // alert(Result);
                        if (Result == "222") {
                            alert("Please fill Experience details");
     ...
     function  qual()
     {
        // alert(33);
         ...
         $.ajax({                ///university
             type: "POST",
             contentType: "application/json; charset=utf-8",
             url: "../HO_Website/qualification_HO.aspx/get_qual_dtl",
             data: "{ input : '" + empid + "' }",
             dataType: "json",
             success: function (Result) {
                 Result = Result.d;
            ...
            function qualicateg() {
                ...
                $.ajax({                ///qualification category
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "../HO_Website/qualification_HO.aspx/qcatg_dtl",
                    data: "{empid:'"+empid+"'}",
                    dataType: "json",
                    success: function (Result) {
                        Result = Result.d;
                        ...
                        $("#qc").change(function () {
                            ...
                            $.ajax({                ///qualification
                                type: "POST",
                                contentType: "application/json; charset=utf-8",
                                url: "../HO_Website/qualification_HO.aspx/qual_dtl_rec",
                                data: "{input:'" + sid + "'}",
                                dataType: "json",
                                success: function (Result) {
                                    Result = Result.d;
            ...
            function empq_dtl_view(empid) {
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "../HO_Website/qualification_HO.aspx/get_qual_dtl_view",
                    data: "{ input: '" + empid + "' }",
                    dataType: "json",
                    success: function (Result) {
                        // alert(Result.d);
...
<%--                    ///////Sandeep--%>
                      <div class="ibox-content"  id="Experience" hidden="hidden">
                            <div class="ibox-table">
                                <div class="table-responsive">
                                    <table class="responsive-table table-striped table-bordered table-hover align-center " id="Table1" style="width:1000px;">
                                <thead style="color: white; grid-row-align:center;background-color:#686b6b">
                                    <tr style="height:30px;font-size:x-small;" >
                                                <th data-class="expand">Qualification Type</th>
                                        <th>Qualification</th>

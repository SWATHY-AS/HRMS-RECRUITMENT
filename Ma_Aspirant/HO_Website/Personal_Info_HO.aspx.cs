...
{
    public partial class Personal_Info_HO : System.Web.UI.Page
    {
        ...
        public static string AgeDetails(string date, string post)
        {
            string s = "";
            ...
            //string ss= tr = HttpContext.Current.Session["type_id"].ToString();
            string age = date + 'µ' + post;
...
//pan verification
    ...
    //"\"VALID\"~\"CYRIAC\"~\"26/04/2019\"~\"CHERUPUSHPAM\""
        ...
        //31
           ...
           string msgid = sms.SendSms();
            ...
            ds = obj.proc_hrm_common_select("44","54", data);
            return "SUCCESS";
        }
        ...
        public static string loginauth(string otp)
        {
           ...
           // System.Net.ServicePointManager.SecurityProtocol = System.Net.SecurityProtocolType.Tls | System.Net.SecurityProtocolType.Tls11 | System.Net.SecurityProtocolType.Tls12;
            ...
            ds = obj.proc_hrm_common_select("44","55", otp);
        ...
        public static List<qual> qual_dtl(string qid,string tp)
        {
            ...
            try
            {
                    ...
                    ds = obj.proc_hrm_common_select("44","7", qid);
        ...
        [WebMethod(EnableSession = true)]
        public static string shortlist(int age, int quali,int per,string data)
        {
            DataTable ds = new DataTable();
            ServiceReference1.ServiceClient obj = new ServiceReference1.ServiceClient();
     //       r_idtype + "~" + r_vote_id + "~" + r_name + "~" + r_hname + "~" + r_dist + "~" + r_state + "~" + r_dob + "~" + r_gender + "~" + r_age + "~" + r_mob + "~" + r_email + "~" + r_qual + "~" + r_university + "~" + r_mark + "~" + r_pyear + "~" + r_baccount + "~" + r_ifsc + "~" + r_pan + "~" + r_reg + "~" + r_br + "~" + r_post;
            string[] qq = data.Split('~');
            string[] qq1 = qq[13].Split('.');
             int vv= Convert.ToInt32(qq1[0].ToString());
            ...
            //{
                ...
                //    if(vv>=50)
                //    {
                        //ds = obj.get_data(18, data+'~'+br + '~' + tr);
             System.Net.ServicePointManager.SecurityProtocol = System.Net.SecurityProtocolType.Tls | System.Net.SecurityProtocolType.Tls11 | System.Net.SecurityProtocolType.Tls12;

                        ds = obj.proc_hrm_common_select("44","18", data);//swathy19dec
                ...
                //    else
                //    {
                //        return "Minimum 50% aggregate required!!";
                //    }
        ...
        [WebMethod()]
        public static string sendsms_mail(string name, string numb, string code, string email)
         
        {
         ...
         //   sinfini_Manappuramhr.mana.SMSTool sms = new sinfini_Manappuramhr.mana.SMSTool();
          ...
          //  sms.ser_flag = 0;
            ...
            sms.Message = "Hi " + name + ", Thank you for applying to Manappuram Job Portal.Your Application ID is" + code + "    https://online.manappuram.com/Ho_Website/Login_HO.aspx Kindly use the link and fill the details";
        ...
        public static string Documents_upload(string upload_file,string post)
        {
         ...
         [WebMethod(EnableSession = true)]
         public static string typedetail(string tid)
         {
             HttpContext.Current.Session["id"] = tid;
             return "SUCCESS";
    ...
    ///
         ...
         public static string loginauth_mail(string otp)
         {
             ...
             ds = obj.proc_hrm_common_select("44","67", otp);
             // if (HttpContext.Current.Session["otp"].ToString() == otp.ToString())
             if (ds.Rows[0][0].ToString() == "111")
             {
                 return "111";

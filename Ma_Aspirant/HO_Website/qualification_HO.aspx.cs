...
{
    public partial class qualification_HO : System.Web.UI.Page
    {
        ...
        public static List<qualctg> qcatg_dtl(string empid)
        {
            ...
            ds = obj.proc_hrm_common_select("44","47", empid);
        ...
        public static List<cand_qualtyp> qual_dtl_rec(string input)
        {
            ...
            ds = obj.proc_hrm_common_select("44","48", input);
            try
            {
                if (ds.Rows.Count > 0)
                {
        ...
        public static List<univ> univ_dtl_rec()
        {
            ...
            ds = obj.proc_hrm_common_select("44","49", "0");
            try
            {
                if (ds.Rows.Count > 0)
                {
            ...
            if (dsqual1.Rows.Count > 0)
            {
             ...
             public static string get_qual_dtl(string input)
             {
                ...
                System.Net.ServicePointManager.SecurityProtocol = System.Net.SecurityProtocolType.Tls | System.Net.SecurityProtocolType.Tls11 | System.Net.SecurityProtocolType.Tls12;
                 ...
                 ds = obj.proc_hrm_common_select("44","50", input);
                 if (ds.Rows.Count > 0)
                 {
             ...
             public static string high_qual(string input)
             {
                 ...
                 ds = obj.proc_hrm_common_select("44","65", input);
                 if (ds.Rows.Count > 0)
                 {


                     s = ds.Rows[0][0].ToString() + '~' + ds.Rows[0][0].ToString();
                 }
             ...
             public static string check_data(string input)
             {
                 ...
                 DataTable ds = new DataTable();
                   ...
                   System.Net.ServicePointManager.SecurityProtocol = System.Net.SecurityProtocolType.Tls | System.Net.SecurityProtocolType.Tls11 | System.Net.SecurityProtocolType.Tls12;
                  // ds = obj.proc_hrm_common_select("44", "84", input); 
                   ds = obj.proc_hrm_common_select("15", "34", input); 
                 if (ds.Rows.Count > 0)
                 {
    ...
    //31may
             ...
             public static string get_form(string input)
             {
                 ...
                 ds = obj.proc_hrm_common_select("44","86", input);
                 if (ds.Rows.Count > 0)
                 {

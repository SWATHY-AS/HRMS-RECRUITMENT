<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Opprtunity.aspx.cs" Inherits="Ma_Aspirant.Opprtunity" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="App_Themes/Theme/assets/js/demo/charts/chart_simple.js"></script>
      <script src="App_Themes/Theme/assets/js/salary.js"></script>
          <script src="App_Themes/Theme/assets/js/ovload.js"></script>

         <%-- <script src="App_Themes/Theme/assets/js/ovbrnchload.js"></script>--%>
  ...
  history.pushState(null, null, 'no-back-button');
        ...
        <script>
                window.onload = function() {
                    var brid = $("[id*=txt_brid]").val();;
                    //alert(brid);
                      $.ajax({                ///salary HK 
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "Opprtunity.aspx/ovbranch_check",
                data: "{input:'"+ brid +"',typ:'H'}",
                dataType: "json",
...
<body>
      <header class="header navbar navbar-fixed-top" role="banner">
                                ...
                                <div class="panel-group" id="accordion">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h2 class="ma-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Jr.Assistant </a></h2>
                                        </div>
                           ...
                           <div class="col-md-8">
                                <div class="form-group col-md-12">
                                        <asp:TextBox ID="txt_br" runat="server" hidden="hidden" ></asp:TextBox>
                                                                            <asp:TextBox ID="txt_brid" runat="server" hidden="hidden" ></asp:TextBox>

                             <label class="col-md-2 cntr-text-op">Location:</label>
                              <div class="col-md-6">
                                    <label class="cntr-text-op1" id="lbl_brname"></label>
                                 </div>                                                         
                              <label class="col-md-2 cntr-text-op">Vaccancy:</label>
                            <div class="col-md-2"> 
                                  <label class="cntr-text-op1" id="lbl_brcount">0</label>
                                    </div>
                                    </div> 
                              <div class="form-group col-md-12">
                             <label class="col-md-2 cntr-text-op">Age Limit:</label>
                              <div class="col-md-6 cntr-text-op" style="color:black;"> 18 - 25
                                </div>                                                         
                              <label class="col-md-2 cntr-text-op">Minimum Qualification:</label>
                            <div class="col-md-2"> 
                                <label class="cntr-text-op" style="color:black;">Any Degree with minimum<span style="color:red"> 40%</span>  Aggregate</label>
                            </div>
                                  </div>
                              <%-- --------------------------------------%>
                                 <div class="form-group col-md-12">
                              ...
                              <option value="0" selected="selected">--SELECT QUALIFICATION TYPE--</option>
                                 ...
                                 <div class="form-group col-md-10" >
                                  ...
                                  <label class="col-md-10" style="color:black;text-align:left" id="lbl_bsalary">0</label>
                                  ...
                                  <label class="col-md-10" style="color:black;text-align:left" >Free for bachelors from far places. </label>
                                      ...
                                      <label class="col-md-10" style="color:black;text-align:left" >No current vaccancies for female candidates</label>
                                   </div>
                                ...
                                <button class="btn btn-danger button3 col-md-1" style="border-radius:25px;width:160px;" type="button" onclick="getpageJA()">
        ...
        <b style="font-family:OpenSans;font-weight:bolder;font-size:14px;">Apply Now <span class="glyphicon glyphicon-hand-right"></span></b> 
                                ...
                                <%--  -----------------------------------------------------------------------------------------------%>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <h2 class="ma-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">House Keeping Staff </a></h2>
                                        </div>
                            ...
                            <div class="col-md-2"> 
                             ...
                             <label class="col-md-2 cntr-text-op">Age Limit:</label>
                              ...
                              <label class="col-md-2 cntr-text-op">Minimum Qualification:</label>
                            <div class="col-md-2"> 
                                <label class="cntr-text-op1">SSLC</label>
                            </div>
                                   </div>
    ...
    <button class="btn btn-danger button3 col-md-1" style="border-radius:25px;width:160px;" type="button" onclick="getpage2()">
        <b style="font-family:OpenSans;font-weight:bolder;font-size:14px;">Apply Now <span class="glyphicon glyphicon-hand-right"></span></b> 
              ...
              <div class="panel panel-default" id="fieldstaff" hidden="hidden">
                                        <div class="panel-heading">
                                            <h2 class="ma-title"><a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">Field Assistant</a></h2>
                                        </div>
                                        <div id="collapseThree" class="panel-collapse collapse">
                                       <div class="panel-body">                                           
                           <div class="col-md-8">
                                <div class="form-group col-md-12">
                                        <asp:TextBox ID="txt_branch" runat="server" hidden="hidden" ></asp:TextBox>
                                                                            <asp:TextBox ID="txt_branchid" runat="server" hidden="hidden" ></asp:TextBox>

                             <label class="col-md-2 cntr-text-op">Location:</label>
                              <div class="col-md-6">
                                    <label class="cntr-text-op1" id="lbl_brname2"></label>
                                 </div>                                                         
                              <label class="col-md-2 cntr-text-op">Vaccancy:</label>
                            <div class="col-md-2"> 
                                  <label class="cntr-text-op1" id="lbl_brcount1">0</label>
                                    </div>
                            ...
                            <div class="col-md-2"> 
                              ...
                              <%-- --------------------------------------%>
                                 ...
                                 <label class="col-md-2 cntr-text-op">Qualification Type:</label>
                              <div class="col-md-6" >
                                    <select class="form-group" id="cmp_typeq1" >
                              <option value="0" selected="selected">--SELECT QUALIFICATION TYPE--</option>
                                          <option value="2">POST GRADUATE</option>
                                          <option value="3" >GRADUATE</option>
                                 ...
                                 <div class="form-group col-md-10" >
                                      <label class="col-md-2" style="color:darkred;" >Basic: </label>
                                  <label class="col-md-10" style="color:black;text-align:left" id="lbl_bsalary1">0</label>
                                   <label class="col-md-2" style="color:darkred;" >Other Benefits: </label>
                                  <label class="col-md-10" style="color:black;text-align:left" >PF,ESI,Gratuity,Insurance,EDLI,(City,Metro,Outstation etc.) Allowances etc.</label>
                                      <label class="col-md-2" style="color:darkred;" >Accommodation: </label>
                                  <label class="col-md-10" style="color:black;text-align:left" >Free for bachelors from far places. </label>
                                ...
                                <button class="btn btn-danger button3 col-md-1" style="border-radius:25px;width:160px;" type="button" onclick="getpageFA()">
        <b style="font-family:OpenSans;font-weight:bolder;font-size:14px;">Apply Now <span class="glyphicon glyphicon-hand-right"></span></b> 
       </button>

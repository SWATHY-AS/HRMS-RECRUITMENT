...
function post_select() {
    ...
    if (ppin != '') {
        ...
        $.ajax({
            type: "POST",
            url: 'Personal_Details_HO.aspx/postofc_dtl',
            data: "{did:'" + ppin + "'}",
            async: false,
            cache: false,
...
function addr()
{
        ...
        if (dpid != -1) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "../HO_Website/Personal_Details.aspx/get_address",
                data: "{input:'" + dpid + "'}",
                async: false,
                cache: false,
                dataType: "json",
...
$.ajax({                ///university
    type: "POST",
    contentType: "application/json; charset=utf-8",
    url: "../HO_Website/Personal_Details_HO.aspx/univ_dtl",
    data: {},
    dataType: "json",
    success: function (Result) {
        Result = Result.d;
...
$.ajax({                ///qualification
    type: "POST",
    contentType: "application/json; charset=utf-8",
    url: "../HO_Website/Personal_Details_HO.aspx/qual_dtl",
    data: {},
    dataType: "json",
    success: function (Result) {
        Result = Result.d;
...
function qualificationadd()//swathy  qualificatio
{
   ...
   // var q3 = $("#txt_unvsty").val();
    ...
    if ($('input[id=chkq]').is(':checked')) {
        ...
        if (q22 != highq) {
            alert("Highest qualification does not matched");
            cleardata();
        }
    }
    ...
    if (q11 == 3 && q6 < 50) 
    {
        alert("minimum qualification graduate and 50% ");
        return;
    }
            ...
            if (row3 == '') {
               ...
               // alert(row2);
                ...
                $.ajax({
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    url: "../HO_Website/qualification_HO.aspx/check_data",
                    data: "{input:'" + row2 + "'}",
                    dataType: "json", beforeSend: function () {
                        return confirm("Are you sure you want to confirm?");
                    },
                    success: function (Result) {
                        ...
                        if (res == '111') {
                            ...
                            $.ajax({
                                type: "POST",
                                contentType: "application/json; charset=utf-8",
                                url: "../HO_Website/qualification_HO.aspx/insert_quali",
                                //     data: "{ input: '" + row2 + "' }",
...
function photo_tab11() {
    ...
    window.open("../HO_Website/candidate_photo_HO.aspx", "_self");
}

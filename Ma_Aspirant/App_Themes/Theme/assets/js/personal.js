    ...
    $("#txt_dob").datepicker({
        ...
        onSelect: function (dateText, inst) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: 'Personal_Info.aspx/AgeDetails',
...
function mail_otp() {
    ...
    $.ajax({
        type: 'POST',
        url: 'Personal_Info.aspx/sendOTPfn_mail',
        data: "{ number : '" + r_mob + "' }",
...
function validatemailOTP() {
    ...
    $.ajax({
        type: "POST",
        url: 'Personal_Info.aspx/loginauth_mail',
        data: "{otp:'" + pp + "'}",
        async: false,
        cache: false,
        contentType: "application/json; charset=utf-8",
  ...
  function confirm_basic() {
      ...
      //alert(r_age);
                ...
                if (r_gender=='' || r_hname == '' || r_hname == '.' || r_dob == '' || mm == 0 || em == 0 || mobver == '' || mailver == '' || bname == '' || r_name == '' || r_idtype == -1 || (r_vote_id == '' && r_idtype == 2) || r_mob == '' || r_email == '' || r_qual == 0 || r_university == 0 || r_mark == '' || r_pyear == '' || r_baccount == '' || r_ifsc == '' || r_pan == '' || r_reg == '') {
                    ...
                    else if (r_gender == '') { alert("Please enter Gender"); }
         ...
         // alert(r_age);
                    ...
                    $.ajax({
                        ...
                        data: "{age:'" + 1 + "',quali:'" + r_qual + "',per:'" + 60 + "',data:'" + data + "'}",
                        async: false,
                        cache: false,
                        contentType: "application/json; charset=utf-8",
                        dataType: "json",

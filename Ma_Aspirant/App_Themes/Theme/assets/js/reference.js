    ...
    if (agree==0 ||ref_name1 == '' || ref_name2 == '' || ref_position1 == '' || ref_position2 == '' ||  ref_mobno1 == '' || ref_mobno2 == '' || ref_mail1 == '' || ref_mail2 == '' || ref_post_office1 == 0 || ref_post_office2 == 0) {
       ...
       // else if (ref_landno1 == '') { alert("Please Enter Land phone number1"); }
        ...
        $.ajax({
            ...
            url: "Reference_per.aspx/insert_ref",
            data: "{input: '" + data1 + "' }",
        ...
        $.ajax({
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "Reference_per.aspx/insert_ref1",
            data: "{input2: '" + data2 + "' }",
            dataType: "json", beforeSend: function () {
                return confirm("Are you sure you want to confirm?");
            },
  ...
  //  $(window).on("load", GetAllProperties);
    function GetAllProperties11() {
        ...
        $.ajax({
            ...
            type: "POST",
            contentType: "application/json; charset=utf-8",
            url: "Reference_per.aspx/state_dtl",
            data: {},
            dataType: "json",
            success: function (Result) {
                ...
                $("#dd_st2").change(function () {
                    ...
                    if (!isNaN(sid)) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: 'Reference_per.aspx/dist_dtl',
                            data: "{stid:'" + sid + "'}",
                            async: false,
                            cache: false,
                            contentType: "application/json; charset=utf-8",
                            ...
                            success: function (Result) {
                                ...
                                $("#dd_dist2").change(function () {
                                    ...
                                    if (!isNaN(dsid)) {
                                        ...
                                        $.ajax({
                                            type: "POST",
                                            url: 'Reference_per.aspx/post_dtl',
                                            data: "{did:'" + dsid + "'}",
                                            async: false,
                                            cache: false,
                                            contentType: "application/json; charset=utf-8",
                                                ...
                                                $("#dd_post2").change(function () {
                                                    ...
                                                    if (!isNaN(dpid)) {
                                                        ...
                                                        $.ajax({
                                                            type: "POST",
                                                            contentType: "application/json; charset=utf-8",
                                                            url: "Reference_per.aspx/get_pin",
                                                            data: "{pid:'" + dpid + "'}",
                                                            async: false,
                                                            cache: false,
                                                            dataType: "json",
...
function cand_load() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "Reference_per.aspx/cand_detail",
        data: {},
        async: false,
        cache: false,
        dataType: "json",
